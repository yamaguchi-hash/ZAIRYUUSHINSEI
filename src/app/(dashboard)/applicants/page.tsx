            ...
            <CardContent className="p-0">
              {applicants.length === 0 ? (
                ...
                <div className="divide-y divide-gray-50">
                  {applicants.map((a) => (
                    <Link key={a.id} href={`/applicants/${a.id}`} className="flex items-center gap-4 px-6 py-4 hover:bg-gray-50 transition-colors">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500">
                          {a.nationality} ・ {a.dateOfBirth ? formatDate(a.dateOfBirth) : "生年月日未登録"}
                        </p>
                      </div>
                      <div className="text-right flex-shrink-0">
                        ...
                        {a.currentVisaType && (
                          <p className="text-xs text-gray-400">{VISA_TYPE_LABELS[a.currentVisaType]}</p>
                        )}
                      </div>
