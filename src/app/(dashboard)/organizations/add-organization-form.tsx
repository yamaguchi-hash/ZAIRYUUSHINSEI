        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <input name="postalCode" value={form.postalCode} onChange={handleChange} placeholder="123-4567" className="input-field" />
            </div>
            <div>
          ...
          <div>
            <label className="block text-xs font-medium text-gray-600 mb-1">番地・建物</label>
            <input name="addressLine" value={form.addressLine} onChange={handleChange} placeholder="1-1-1 〇〇ビル" className="input-field" />
          </div>
          <div className="grid grid-cols-2 gap-2">
            <div>
