...
const ALL_QUESTIONS: Question[] = [
  ...
  { key: "familyNameJa",   section: "基本情報", label: "3. 氏名（漢字）", note: "漢字氏名がある場合（例: 山田 太郎）" },
  ...
  { key: "supporterFamilyNameJa", section: "扶養者の情報（R型）", label: "扶養者 氏名（漢字）", note: "例: ファム ティ トム", categories: ["R"] },
